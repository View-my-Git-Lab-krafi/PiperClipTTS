...
class ClipboardMonitor:
    ...
    def setup_gui(self):
        ...
        from_language_label.grid(row=2, column=0, padx=10, pady=5)
        ...
        to_language_dropdown.grid(row=3, column=1, padx=10, pady=5)
        ...
        mode_checkbox.grid(row=4, column=1, padx=10, pady=5)
        ...
        instruction_label.grid(row=5, column=0, columnspan=2, padx=35, pady=15, sticky="nsew")
    ...
    def text_to_speech(self, text, translated=False):
        ...
        if translated:
            model_path = self.models["en_US-bryce"]
        else:
